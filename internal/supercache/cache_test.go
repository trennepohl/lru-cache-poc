...
func TestCacheKeyLimitIsRespected(t *testing.T){
	c, err := supercache.New(cache.Config{MaxKeyCount: 3})
...
func TestCount(t *testing.T){
	c, _:= supercache.New(cache.Config{MaxKeyCount: 3})
...
func BenchmarkScalableCacheWrites(b *testing.B){
	c, _ := supercache.New(cache.Config{MaxKeyCount: 100})
	for n := 0; n < b.N; n++ {
